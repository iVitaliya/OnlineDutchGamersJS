...
import { Database, guildMe, MAIN_OWNER } from "../lib/index";
...
export class GuildGuardian {
  ...
  // https://github.com/lorencerri/discord-guardian/blob/8d2e66ed5bf3857ee8a36f87e1434251748ca9e2/structures/Guild.js#L157
}
